...
{
    public class CancelProductionHandler : BackgroundService
    {
        ...
        public CancelProductionHandler(
        ...
        private async Task ProcessEventAsync(object sender, BasicDeliverEventArgs e)
        {
            ...
            try
            {
                var model = JsonConvert.DeserializeObject<CancelProductionModel>(value);

                var service = scope.ServiceProvider.GetRequiredService<ICancelProductionService>();
